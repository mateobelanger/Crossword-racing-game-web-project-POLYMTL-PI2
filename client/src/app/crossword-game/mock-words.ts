...
export const words: Word[] = [
    ...
    {row: 0, column: 0, direction: Direction.Vertical, size: 3, value: "sat",
     definition: "This definition is actually really long because like I needed to do a test for something that I wasn't sure about." },
